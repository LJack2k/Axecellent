...
public final class Config {
    ...
    public static final ModConfigSpec.EnumValue<CutMode> MODE = BUILDER
            .comment("How the tree comes apart.",
    ...
    public static final ModConfigSpec.BooleanValue HELD_SNEAK_STARTS_AT_YOU = BUILDER
            .comment("HELD only: what crouching does.",
                    ...
                    "false - crouching falls back to sneakToDisable below, i.e. it turns the",
            ...
            .translation("axecellent.configuration.held_sneak_starts_at_you")
            .define("chainsaw.heldSneakStartsAtYou", true);

    public static final ModConfigSpec.IntValue HELD_LOGS_PER_CHOP = BUILDER
            .comment("HELD only: how many logs one completed chop takes down.",
                    ...
                    "nothing moves - there is no timer",
                    "running underneath. 1 means one chop, one log, which is the whole point of the",
                    "mode; raise it if that feels too slow for big trees.")
            .translation("axecellent.configuration.held_logs_per_chop")
            .defineInRange("chainsaw.heldLogsPerChop", 1, 1, 64);

    public static final ModConfigSpec.IntValue HELD_RESUME_WINDOW = BUILDER
            .comment("HELD only: how many seconds a part-cut tree waits for your next chop before",
                    "it gives up and the rest becomes ordinary blocks again.")
            .translation("axecellent.configuration.held_resume_window")
            .defineInRange("chainsaw.heldResumeWindow", 10, 1, 300);

    public static final ModConfigSpec.IntValue LOGS_PER_TICK = BUILDER
            .comment("PROGRESSIVE only: how many logs fall per tick. Their leaves ride along for",
                    "free, so this alone sets the pace - 2 takes a 64-log tree down in about 1.6s.",
                    "Higher is faster and less visible; 20 or more is effectively instant.")
            .translation("axecellent.configuration.logs_per_tick")
            .defineInRange("chainsaw.logsPerTick", 2, 1, 64);

    public static final ModConfigSpec.IntValue MAX_CONCURRENT_CUTS = BUILDER
    ...
    public static final ModConfigSpec.IntValue MAX_LOGS = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue CLEAR_LEAVES = BUILDER
    ...
    public static final ModConfigSpec.IntValue MAX_LEAVES = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue REQUIRE_LEAVES = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue DROPS_AT_BREAK_POSITION = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue SNEAK_TO_DISABLE = BUILDER
            .comment("Hold sneak to break a single log without cutting the whole tree.",
                    "In HELD mode this is overridden by heldSneakStartsAtYou above, which repurposes",
    ...
    public static final ModConfigSpec.BooleanValue ENABLED_IN_CREATIVE = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue RESPECT_BLOCK_PROTECTION = BUILDER
    ...
    public static final ModConfigSpec.IntValue DURABILITY_PER_LOG = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue DURABILITY_FOR_LEAVES = BUILDER
